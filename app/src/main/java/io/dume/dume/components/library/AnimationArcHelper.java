...
public class AnimationArcHelper implements com.amalbit.trail.contract.Animator {
    ...
    public void init() {
        ...
        if (firstTimeArcAnimator == null) {
            ...
            firstTimeArcAnimator.setDuration(1800);
        ...
        if (secondTimeArcAnimator == null) {
            ...
            secondTimeArcAnimator.setDuration(1800);
        ...
        if (colorArcAnimation == null) {
            ...
            colorArcAnimation.setDuration(1400); // milliseconds
            colorArcAnimation.setStartDelay(900);
        }
