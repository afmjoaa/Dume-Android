...
import io.dume.dume.myGeoFIreStore.callbacks.EventListenerBridge;
import io.dume.dume.myGeoFIreStore.callbacks.GeoQueryDataEventListener;
import io.dume.dume.myGeoFIreStore.callbacks.GeoQueryEventListener;
import io.dume.dume.myGeoFIreStore.core.GeoHash;
import io.dume.dume.myGeoFIreStore.core.GeoHashQuery;
import io.dume.dume.myGeoFIreStore.util.GeoUtils;
...
public class GeoQuery {
    ...
    private static class LocationInfo {
        ...
        LocationInfo(GeoPoint location, boolean inGeoQuery, DocumentSnapshot documentSnapshot) {
            ...
            this.geoHash = new GeoHash(new io.dume.dume.myGeoFIreStore.GeoLocation(location.getLatitude(), location.getLongitude()));
    ...
    private final io.dume.dume.myGeoFIreStore.GeoFirestore geoFirestore;
     ...
     */
    GeoQuery(io.dume.dume.myGeoFIreStore.GeoFirestore geoFirestore, GeoPoint center, double radius, String commonQueryString) {
    ...
    private boolean locationIsInQuery(GeoPoint location) {
        return GeoUtils.INSTANCE.distance(new io.dume.dume.myGeoFIreStore.GeoLocation(location.getLatitude(), location.getLongitude()), new io.dume.dume.myGeoFIreStore.GeoLocation(center.getLatitude(), center.getLongitude())) <= this.radius;
    }
    ...
    private void setupQueries() {
        ...
        Set<GeoHashQuery> newQueries = GeoHashQuery.Companion.queriesAtLocation(new io.dume.dume.myGeoFIreStore.GeoLocation(center.getLatitude(), center.getLongitude()), radius);
    ...
    private void childAdded(DocumentSnapshot documentSnapshot) {
        GeoPoint location = io.dume.dume.myGeoFIreStore.GeoFirestore.Companion.getLocationValue(documentSnapshot);
        if (location != null) {
                ...
                public void onComplete(@NonNull Task<DocumentSnapshot> task) {
                    if (task.isSuccessful()){
                        ...
                        synchronized (GeoQuery.this) {
                            ...
                            GeoHash hash = (location != null) ? new GeoHash(new io.dume.dume.myGeoFIreStore.GeoLocation(location.getLatitude(), location.getLongitude())) : null;
